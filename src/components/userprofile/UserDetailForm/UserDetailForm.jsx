  ...
  return (
    <div className='UDformContainer'>
        <div className='UDformTitleContainer'>
            ...
            <div className='UDIcon'><FaPlus/></div>
        </div>
        <div>
            <div className='UDFormWrapper'>
                ...
                <form className="UDform">
                      ...
                      profileUpdateInput.map((FormInput)=>{
                        return(
                          <div className='Udinputwrapper' key={FormInput.id}>
                            <InputType2 
                            key={FormInput.id} {...FormInput}//input array propperties passed as props
                  ...
                  <button className='UDsubmitbtn' onClick={handleSubmitForm}>Save Changes</button>
                </form>
            </div>
        </div>
    </div>
