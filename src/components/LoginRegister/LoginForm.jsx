  ...
  const register = async (e) => {
    ...
    try {
      ...
      await updateProfile(auth.currentUser, {
        displayName: valuesReg.username,
      });
      console.log(user);
        ...
        <div className="loginForm-inner">
          ...
          <form className="login-form-inputs">
            {userOption === "login"
              ? InputsProps.map((input) => (
                  <InputType1
                    key={input.id}
                    {...input} //input array propperties passed as props
              ...
              : RegisterProps.map((registerInput) => (
                  <InputType1
                    ...
                    {...registerInput} //input array propperties passed as props
          ...
          <div className="inputform-remMe-container">
            <label className="inputform-remMe-text">
              <input
                className="inputform-remMe-checkbox"
                type="checkbox"
                checked={checked}
          ...
          {userOption === "login" ? (
            ...
            <button className="loginForn-btn" onClick={register}>
              Sign Up
            </button>
          )}
          ...
          {userOption === "login" ? (
            <div className="loginForm-register">
              Not a Member?
              <span id="register" onClick={handleUserOption}>
                {" "}
                Register
              </span>
            </div>
            ...
            <div className="loginForm-register">
              Already a member?
              <span id="login" onClick={handleUserOption}>
                {" "}
                Sign In
              </span>
            </div>
